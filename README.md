...
Just open it with a browser, runs locally without external connections (beside GET to licensebuttons.net for CC-BY-SA badge), saves progress **only in local storage of browser, localStorage (STORAGE_KEY = "cis_assessment_v81a";)**. Reset and Export function included.
...
Note: Search for the changes in CIS Controls v8.1 about the Decision Methodology for Asset Classes (e.g. "Documentation" added as Asset Class). 
